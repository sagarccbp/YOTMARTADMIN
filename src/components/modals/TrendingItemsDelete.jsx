...
export default function TrendingItemsDelete(props) {
  ...
  const deleteCategory = categoryId => {
    ...
    fetch(
      `${API_SERVER}homeScreenItems/trendingCollections/` + props.item._id,
      requestOptions
    )
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header>
          <Modal.Title className="realfoodcolor">
            Are you sure, Want to delete this trending items?
          </Modal.Title>
          {/* <button
            onClick={handleClose}
            type="button"
