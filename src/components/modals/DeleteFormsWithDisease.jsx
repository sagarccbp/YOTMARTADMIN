...
export default function DeleteFormsWithDisease(props) {
  ...
  const deleteFormsWithDisease = () => {
    ...
    fetch(
      API_SERVER + "nutritionist/form-with-diease/" + props.item._id,
      requestOptions
    )
        ...
        <Modal.Body>
          <div className="col-md-12 text-center">
            ...
            <button
              ...
              onClick={() => deleteFormsWithDisease()}>
              Delete
            </button>
          </div>
        </Modal.Body>
