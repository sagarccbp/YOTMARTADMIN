...
// import {getOrders} from "../../rest/ApiService.js";
      ...
      <section className="section">
        <div className="section-header">
          ...
          <div className="section-header-breadcrumb">
            ...
            <div className="breadcrumb-item">User Statistics</div>
          </div>
        </div>
        <div className="section-body">
          <div className="row">
            <div
              ...
              <div className="card card-ratio card-primary">
                <div
                  className="card-header cen"
                  // onClick={() => {
                  //   setSelectedItem("ALL");
                  // }}
                >
